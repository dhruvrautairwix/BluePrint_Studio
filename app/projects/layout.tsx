...
/**
 * Projects page layout that renders the home page as background
 * and the projects page content as an overlay on top.
 * 
 * This layout ensures:
 * - Home page stays rendered and visible underneath
 * - Projects page renders as fullscreen overlay
